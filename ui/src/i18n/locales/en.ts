...
export const en: TranslationMap = {
  ...
  sessionsView: {
    ...
    activeTooltip:
      "Only sessions updated in the last {count} minutes. Leave empty to search/browse the full store.",
    limitTooltip: "Optional cap when grouping. Flat list paging uses the page size control below.",
    ...
    searchPlaceholder: "Search all sessions by key, label, agent, kind…",
