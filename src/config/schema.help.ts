...
export const FIELD_HELP: Record<string, string> = {
  ...
  "tools.longTask.retention.succeededDays":
    "How many days to keep succeeded long-task records (default: 7). Fractional days are allowed (0.1).",
  "tools.longTask.retention.failedDays":
    "How many days to keep failed, timed_out, and cancelled long-task records (default: 7). Fractional days are allowed (0.1).",
  "tools.longTask.retention.lostDays":
    "How many days to keep lost long-task records (default: 1). Fractional days are allowed (0.1).",
  "tools.longTask.retention.outputDays":
    "How many days to keep full long-task output files (default: 3). Fractional days are allowed (0.1).",
  ...
  "tools.message.deliveryContext":
    'After a successful message(action=send), append a model-visible and gateway-visible outbound_message record with the full original tool args plus from/to channel identity. "target" (default) writes to the outbound peer session; "source" to the requester session; "both" writes both; "off" keeps legacy delivery-mirror-only behavior (UI may show a compressed mirror; model replay drops it). When target is included, the compressed delivery-mirror for that send is skipped to avoid dual bubbles.',
