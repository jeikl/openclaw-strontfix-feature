...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.longTask.shortPolls": "Long-task Short Polls",
  "tools.longTask.shortPollTimeoutMs": "Long-task Short Poll Timeout (ms)",
  "tools.longTask.maxWaitMs": "Long-task Max Wait (ms)",
  "tools.longTask.blockEndTurn": "Long-task Block End Turn",
  "tools.longTask.retention.succeededMs": "Long-task Succeeded Retention (ms)",
  "tools.longTask.retention.failedMs": "Long-task Failed Retention (ms)",
  "tools.longTask.retention.lostMs": "Long-task Lost Retention (ms)",
  "tools.longTask.retention.outputMs": "Long-task Output Retention (ms)",
  ...
  "tools.message.deliveryContext": "Message Delivery Context",
