...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.longTask.retention.succeededDays": "Long-task Succeeded Retention (days)",
  "tools.longTask.retention.failedDays": "Long-task Failed Retention (days)",
  "tools.longTask.retention.lostDays": "Long-task Lost Retention (days)",
  "tools.longTask.retention.outputDays": "Long-task Output Retention (days)",
